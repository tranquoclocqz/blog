...
<head>
    ...
    <link rel="stylesheet" type="text/less" href="{{ asset('public/admin/css/style.less') }}">
    <script src="//cdnjs.cloudflare.com/ajax/libs/less.js/3.9.0/less.min.js"  data-env="development"></script>
